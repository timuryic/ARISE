...
const i18n = {
    ...
    strings: {
        ru: {
            ...
            activeEffects: 'АКТИВНЫЙ ЭФФЕКТ', noEffects: 'Нет активных эффектов', timeRemaining: 'Осталось',
            ...
            elixirBtn: 'ПОНЯТНО, ВЫПИТЬ ЭЛИКСИР',
            penaltyWarning: '<strong>ВНИМАНИЕ:</strong> Невыполнение квеста = <strong>-40 XP</strong> (за каждый).',
            penaltyNotification: 'Вы потеряли XP из-за невыполненных квестов!',
            elixirActive: 'Эликсир Жизни активен! Штрафы отключены на 24ч.',
        ...
        en: {
            ...
            activeEffects: 'ACTIVE EFFECTS', noEffects: 'No active effects', timeRemaining: 'Time left',
            ...
            elixirBtn: 'UNDERSTOOD, DRINK ELIXIR',
            penaltyWarning: '<strong>WARNING:</strong> Incomplete quest = <strong>-40 XP</strong> (each).',
            penaltyNotification: 'You lost XP due to incomplete quests!',
            elixirActive: 'Elixir of Life active! No penalties for 24h.',
