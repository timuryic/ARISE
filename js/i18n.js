...
const i18n = {
    ...
    strings: {
        ru: {
            ...
            bosses: { e: 'ГОБЛИН-РАЗВЕДЧИК', d: 'HIGH BERTORK', c: 'STARIY WIZARD', b: 'VITAL THE BANDIT', a: 'ZOMBOMIKE', s: 'БЕРУ' },
            stats: {
        ...
        en: {
            ...
            bosses: { e: 'GOBLIN SCOUT', d: 'HIGH BERTORK', c: 'STARIY WIZARD', b: 'VITAL THE BANDIT', a: 'ZOMBOMIKE', s: 'BERU' },
            stats: {
